 ...
 * eyeheight in meters.*/
static const float initCamPos[3]  = {0.0f,1.0f,-4.5f};
...
void keyboard(GLFWwindow* window, int key, int scancode, int action, int mods)
{
	...
	switch(key)
	{
		...
		case GLFW_KEY_PERIOD:
			...
			switch(renderStyle)
			{
				case 0: printf("Render style: diffuse shading (no color)\n"); break;
				case 1: printf("Render style: diffuse shading with normalmap (no color)\n"); break;
				case 2: printf("Render style: display normals as a color\n"); break;
				case 3: printf("Render style: display normals as a color (with normals updated by normal map)\n"); break;
				case 4: printf("Render style: diffuse/color texture with diffuse shading using original normal.\n"); break;
				case 5: printf("Render style: diffuse/color texture with diffuse shading using normalmap normal.\n"); break;
				case 6: printf("Render style: diffuse/color texture, diffuse shading with normalmap, specular shading\n"); break;
			}
			break;
	}
}
